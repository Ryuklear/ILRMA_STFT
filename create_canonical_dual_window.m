function dual_window = create_canonical_dual_window(analysis_window,time_skip)
%CREATE_CANONICAL_DUAL_WINDOW creates the canonical dual window for an analytic window
%
%% -- Inputs ---------------------------------------------------------
% analysis_window:   nonzero analysis window (window_length x 1)
